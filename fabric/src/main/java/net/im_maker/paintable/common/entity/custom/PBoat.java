...
public class PBoat extends Boat {
    ...
    public Item getDropItem() {
        return PItems.PAINTED_BOATS.get(getModVariant().getColor().getId());
    }
    ...
    public static class Type implements StringRepresentable {
        ...
        private Type(DyeColor color) {
            ...
            this.planks = PBlocks.PAINTED_PLANKS.get(color.getId());
        ...
        public static Type byId(int id) {
            return BY_ID.computeIfAbsent(id, k -> new Type(DyeColor.byId(k)));
        }
    }
