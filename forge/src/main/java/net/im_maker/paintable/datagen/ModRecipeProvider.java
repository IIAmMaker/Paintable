...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        for (DyeColor color : DyeColor.values()) {
            ...
            if (ModList.get().isLoaded("duy_depot")) {
            ...
            TagKey<Item> logs = PTags.Items.PAINTED_LOG_TAGS[color.getId()];
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, blockN(color + "_paint_bucket"))
                    ...
                    .pattern("DWD")
                    .pattern(" P ")
                    .define('D', Paintable.getItemFromString(dyeID, color + "_dye"))
            ...
            //paintBrushRecipe(pWriter, color, bricks, PTags.Items.PAINTABLE_BRICKS);
            //paintBrushRecipe(pWriter, color, brick_stairs, PTags.Items.PAINTABLE_BRICK_STAIRS);
            //paintBrushRecipe(pWriter, color, brick_slab, PTags.Items.PAINTABLE_BRICK_SLABS);
            //paintBrushRecipe(pWriter, color, brick_wall, PTags.Items.PAINTABLE_BRICK_WALLS);
            //paintBrushRecipe(pWriter, color, mud_bricks, PTags.Items.PAINTABLE_MUD_BRICKS);
            //paintBrushRecipe(pWriter, color, mud_brick_stairs, PTags.Items.PAINTABLE_MUD_BRICK_STAIRS);
            //paintBrushRecipe(pWriter, color, mud_brick_slab, PTags.Items.PAINTABLE_MUD_BRICK_SLABS);
            //paintBrushRecipe(pWriter, color, mud_brick_wall, PTags.Items.PAINTABLE_MUD_BRICK_WALLS);
        }
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, PItems.PAINT_BRUSH.get())
                .pattern("FFF")
                .pattern(" I ")
                .pattern(" S ")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, ModBlocks.PAINT_BUCKET.get())
                .requires(PTags.Items.FILLED_PAINT_BUCKET)
                .unlockedBy(getHasName(ModBlocks.PAINT_BUCKET.get()), has(ModBlocks.PAINT_BUCKET.get()))
